...
class TailwindButtonComponentStories < ViewComponent::Storybook::Stories
  ...
  story :default do
    ...
    controls do
      ...
      swift_select :variant,
                   options: %i[primary secondary success danger warning info ghost link],
                   default: :primary
      swift_select :size,
                   options: %i[xs sm md lg xl],
                   default: :md
  ...
  story :variants do
    ...
    controls do
      ...
      swift_select :size, options: %i[sm md lg], default: :md
    end
  ...
  story :states do
    ...
    controls do
      ...
      swift_select :variant,
                   options: %i[primary secondary danger],
                   default: :primary
    end
  ...
  story :with_icons do
    ...
    controls do
      ...
      swift_select :variant,
                   options: %i[primary secondary ghost],
                   default: :primary
      swift_select :icon,
                   options: %i[star heart download arrow_right],
                   default: :star
    end
