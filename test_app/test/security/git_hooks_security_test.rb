...
class GitHooksSecurityTest < ActiveSupport::TestCase
  ...
  test "pre-build hook quotes all variables" do
    ...
    unquoted_git_variables = lines.filter_map.with_index do |line, index|
    ...
    assert_empty unquoted_git_variables,
      "SECURITY: Git commands contain unquoted variables:\n#{unquoted_git_variables.join("\n")}"
  end
