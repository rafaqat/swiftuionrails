...
class HtmlSafetyTest < ActiveSupport::TestCase
  ...
  test "add_observation_metadata never serializes observed values" do
    component = TestComponent.new
    ...
    refute_includes component._content, "alert"
    refute_includes component._content, "xss"
    assert_includes component._content, "__invalidated"
    assert_includes component._content, "__revision"
  end
