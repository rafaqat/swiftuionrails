  ...
  describe 'component generation' do
    ...
    context 'error handling' do
      ...
      it 'validates invalid prop definitions' do
        ...
        expect { run_generator ['MyComponent', ':String'] }.to raise_error(SystemExit) { |error|
    ...
    context 'prop validation' do
      it 'validates prop names' do
        ...
        expect { run_generator ['MyComponent', 'class:String'] }.to raise_error(SystemExit) { |error|
          expect(error.status).to eq(1)
        }
      end
  ...
  describe 'security' do
    ...
    it 'prevents code injection in prop definitions' do
      ...
      malicious_props.each do |prop|
        expect { run_generator ['MyComponent', prop] }.to raise_error(SystemExit) { |error|
          expect(error.status).to eq(1)
        }
      end
    end
