...
class PlaygroundV2Controller < ApplicationController
  # Skip CSRF for preview and completion endpoints
  skip_before_action :verify_authenticity_token, only: [:preview, :completions, :signatures]
  ...
  def preview
    ...
    begin
      ...
      temp_class_name = "PlaygroundV2Component#{SecureRandom.hex(8)}"
      ...
      respond_to do |format|
        format.turbo_stream do
          render turbo_stream: turbo_stream.update("preview-container-v2", @rendered_html)
        end
