...
export class PlaygroundDataManager {
  ...
  // Decompress data (using built-in browser APIs)
  decompressData(compressedBase64) {
    try {
      // For V2, we use the DecompressionStream API (modern browsers)
      if ('DecompressionStream' in window) {
        // This is a placeholder - we'll implement if needed
        console.warn('Browser decompression available but not implemented - using server data');
        return null;
      }
