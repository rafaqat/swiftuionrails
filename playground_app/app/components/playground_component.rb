...
class PlaygroundComponent < ApplicationComponent
  ...
  def preview_section
    div.w("1/2").h("full").flex.flex_col.bg("white") do
      ...
      div.flex_1.bg("gray-100").overflow_auto.p(4).flex.justify_center do
        ...
        div(
            id: "preview-container", # Removed -v2
  ...
  def theme_switcher
    ...
    ).text_sm.rounded.border_gray_300 do
  ...
  def hidden_preview_form
    ...
    form(action: "/playground/preview", method: :post, data: { playground_target: "form" }) do
      input(type: "hidden", name: "code", data: { playground_target: "codeInput" })
    end
  end
