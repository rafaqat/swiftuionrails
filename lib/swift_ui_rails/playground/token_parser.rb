  ...
  module Playground
    ...
    class TokenParser
      ...
      def parse_string(quote, line, column)
        ...
        raise ParseError, "Unterminated string at line #{line}, column #{column}" if current_char != quote
      ...
      def parse_method_chain
        ...
        while current_token&.type == DOT
          ...
          block = parse_block if [DO, LBRACE].include?(current_token&.type)
      ...
      def parse_primary
        ...
        when LPAREN
          ...
          raise ParseError, "Expected ')' at line #{current_token&.line}" if current_token&.type != RPAREN
      ...
      def parse_method_or_value
        ...
        when 'nil'
          ...
          # Check for block
          block = parse_block if current_token&.type == DO
      ...
      def parse_block
        ...
        raise ParseError, "Expected '#{end_token}' at line #{current_token&.line}" if current_token&.type != end_token
